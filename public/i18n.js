(function () {
  ...
  const dict = {
    vi: {
      ...
      newBetHintOverUnder: 'Ví dụ tài/xỉu: Mốc tài/xỉu = 2.25 hoặc 2.75, Odds Tài = 1.95, Odds Xỉu = 1.95',
    ...
    en: {
      ...
      newBetHintOverUnder: 'Example over/under: total line = 2.25 or 2.75, Over odds = 1.95, Under odds = 1.95',
